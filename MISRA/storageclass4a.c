...
main.c:14:5: note: previous definition of 'last' with type 'int (*)()'
   14 | int last();
      |     ^~~~
main.c:43:9: error: 'new' redeclared as different kind of symbol
   43 |     int new(i){
      |         ^~~
main.c:15:5: note: previous definition of 'new' with type 'int (*)(int)'
   15 | int new(int i);
      |     ^~~
main.c: In function 'new':
main.c:43:9: warning: type of 'i' defaults to 'int' [-Wimplicit-int]
   43 |     int new(i){
      |         ^~~
